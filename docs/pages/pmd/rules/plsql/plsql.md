...
*   [Indentation](pmd_rules_plsql_codestyle.html#indentation): This rule checks for long lines. Please note that comments are not ignored.            This rule ...
*   [Keywords](pmd_rules_plsql_codestyle.html#keywords): This rule checks for long lines. Please note that comments are not ignored.            This rule ...
...
*   [ReservedWords](pmd_rules_plsql_codestyle.html#reservedwords): This rule checks for long lines. Please note that comments are not ignored.            This rule ...
*   [VariableNames](pmd_rules_plsql_codestyle.html#variablenames): Rename names need to be p_.
*   [VariableParameterNames](pmd_rules_plsql_codestyle.html#variableparameternames): Rename names need to be p_.
