...
keywords: Code Style, AvoidTabCharacter, CodeFormat, MisplacedPragma, ForLoopNaming, LineLength, VariableNames, VariableParameterNames, ReservedWords, Keywords, Indentation
language: PLSQL
---
...
**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.plsql.rule.codestyle.IndentationRule](https://github.com/pmd/pmd/blob/master/pmd-plsql/src/main/java/net/sourceforge/pmd/lang/plsql/rule/codestyle/IndentationRule.java)

**Use this rule by referencing it:**
``` xml
<rule ref="category/plsql/codestyle.xml/Indentation" />
```
...
**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.plsql.rule.codestyle.KeywordsRule](https://github.com/pmd/pmd/blob/master/pmd-plsql/src/main/java/net/sourceforge/pmd/lang/plsql/rule/codestyle/KeywordsRule.java)

**Use this rule by referencing it:**
``` xml
<rule ref="category/plsql/codestyle.xml/Keywords" />
```
...
**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.plsql.rule.codestyle.ReservedWordsRule](https://github.com/pmd/pmd/blob/master/pmd-plsql/src/main/java/net/sourceforge/pmd/lang/plsql/rule/codestyle/ReservedWordsRule.java)

**Use this rule by referencing it:**
``` xml
<rule ref="category/plsql/codestyle.xml/ReservedWords" />
```
...
Rename names need to be p_.

**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.plsql.rule.codestyle.VariableNamesRule](https://github.com/pmd/pmd/blob/master/pmd-plsql/src/main/java/net/sourceforge/pmd/lang/plsql/rule/codestyle/VariableNamesRule.java)

**Example(s):**

``` sql
https://alm.andritz.com/confluence/display/ISaagXCRM/Naming+Conventions
-- good example
p_opp_id   IN opp_sales_teams.opp_id%TYPE

-- bad example
o_opp_id   IN opp_sales_teams.opp_id%TYPE
```

**Use this rule by referencing it:**
``` xml
<rule ref="category/plsql/codestyle.xml/VariableNames" />
```
...
**This rule is defined by the following Java class:** [net.sourceforge.pmd.lang.plsql.rule.codestyle.VariableParameterNamesRule](https://github.com/pmd/pmd/blob/master/pmd-plsql/src/main/java/net/sourceforge/pmd/lang/plsql/rule/codestyle/VariableParameterNamesRule.java)
...
**Use this rule by referencing it:**
``` xml
<rule ref="category/plsql/codestyle.xml/VariableParameterNames" />
```
